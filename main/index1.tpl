       ...
       <div class="toolbar">
        ...
        <div class="toolbar-dropdown">
          ...
          <div class="toolbar-section" >
           @visualcart@
           <!-- Shopping Cart Section" -->
   <div class="table-responsive shopping-cart mb-0" id="cart">
     <table class="table">
      <thead>
        <tr>
          <th colspan="2">
            <div class="d-flex justify-content-between align-items-center">Р вЂњРІР‚в„ўР вЂњР’В®Р вЂњРЎС›Р вЂњР’В Р вЂњР’В°Р вЂњР’В»<a class="navi-link text-uppercase" href="cart.html"><span class="text-xxs">Expand Cart</span><i class="material-icons keyboard_arrow_right"></i></a></div>
        </th>
          </tr>
      </thead>
      <tbody>
          <tr>
      <td>
        <div class="product-item"><a class="product-thumb" href="shop-single.html"><img src="images/shop/cart/01.jpg" alt="Product"></a>
      ...
      <td class="text-center"><a class="remove-from-cart" href="index.html#"><i class="material-icons icon_close"></i></a></td>
      </tr>
      <tr>
        <td>
          <div class="product-item"><a class="product-thumb" href="shop-single.html"><img src="images/shop/cart/02.jpg" alt="Product"></a>
      <div class="product-info">
      ...
      <tr>
        <td>
          <div class="product-item"><a class="product-thumb" href="shop-single.html"><img src="images/shop/cart/03.jpg" alt="Product"></a>
      <div class="product-info">
